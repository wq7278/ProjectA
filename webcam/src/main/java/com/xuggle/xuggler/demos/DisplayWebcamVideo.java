...
/**
 * Takes a FFMPEG device driver name (ex: "video4linux2"), and a device name
 * (ex: /dev/video0), and displays video from that device. For example, a web
 * camera.
 * <p>
 ...
 * 
 * <pre>
 * java -cp %XUGGLE_HOME%\share\java\jars\xuggle-xuggler.jar com.xuggle.xuggler.demos.DisplayWebcamVideo vfwcap 0
 * </pre>
 * 
 * </li>
 * <li>Linux:
 * 
 * <pre>
 * java -cp $XUGGLE_HOME/share/java/jars/xuggle-xuggler.jar com.xuggle.xuggler.demos.DisplayWebcamVideo video4linux2 /dev/video0
 * </pre>
 * 
 * </li>
 * </ul>
...
public class DisplayWebcamVideo {
	 ...
	 * available, nor can you query what their capabilities are without actually
	 * opening the device. Sorry, but that's how FFMPEG rolls.
	 * </p>
	 * 
	 * @param args
	 *            Must contain two strings: a FFMPEG driver name and a device
	 *            name (which is dependent on the FFMPEG driver).
	 */
